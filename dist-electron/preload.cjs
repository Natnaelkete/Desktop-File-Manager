...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  ...
  openWith: (path) => electron.ipcRenderer.invoke("open-with", path),
  getOpenWithApps: (path) => electron.ipcRenderer.invoke("get-open-with-apps", path),
  openWithApp: (appPath, path) => electron.ipcRenderer.invoke("open-with-app", appPath, path),
  openTerminal: (path) => electron.ipcRenderer.invoke("open-terminal", path),
  quickAction: (action, payload) => electron.ipcRenderer.invoke("quick-action", action, payload),
  ...
  getDriverReport: () => electron.ipcRenderer.invoke("get-driver-report"),
  getStartupItems: () => electron.ipcRenderer.invoke("get-startup-items"),
  disableStartupItem: (item) => electron.ipcRenderer.invoke("disable-startup-item", item),
  getProcessList: () => electron.ipcRenderer.invoke("get-process-list"),
  killProcess: (pid) => electron.ipcRenderer.invoke("kill-process", pid),
  cleanTemp: () => electron.ipcRenderer.invoke("clean-temp"),
  openWindowsUpdate: () => electron.ipcRenderer.invoke("open-windows-update"),
  openStartupSettings: () => electron.ipcRenderer.invoke("open-startup-settings"),
